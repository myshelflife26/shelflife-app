...
import { TrendingUp, Users, Sparkles, Flame, Heart, ThumbsUp, UserPlus, ShieldOff, Flag, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Activity, Clock, Package, MessageSquare, Eye } from 'lucide-react';
